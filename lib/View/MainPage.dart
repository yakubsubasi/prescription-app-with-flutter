    ...
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(
              child: SearchWidget(
                  text: query, onChanged: searchRecete, hintText: "Ara")),
          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Card(
                child: PopupMenuButton<String>(
                    ...
                    itemBuilder: (BuildContext context) {
                      return List.generate(
                          _allSpecialities.length,
                          (index) => PopupMenuItem(
                              child: Text(_allSpecialities[index]),
                              value: _allSpecialities[index]));
                    })),
          )
        ],
      ),
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => DetailPage(
                              recete: _receteler![index],
                            )),
                  );
                },
                title: Text(
                  _receteler![index].name ?? "",
